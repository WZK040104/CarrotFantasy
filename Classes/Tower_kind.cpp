...
int tower0_upgrade_coins[MAXlevel] = { 20,40,60,100 };						//一级升二级的钱为tower0_upgrade_coins[1]		普通炮台
...
int tower1_upgrade_coins[MAXlevel] = { 30,60,90,150 };						//一级升二级的钱为tower1_upgrade_coins[1]		伤害偏高，射速较快，攻击距离较短
...
int tower2_upgrade_coins[MAXlevel] = { 15,35,55,80 };						//一级升二级的钱为tower2_upgrade_coins[1]		伤害较低，距离远但能提供减速效果（还没写）
...
int tower3_upgrade_coins[MAXlevel] = { 30,60,90,150 };						//一级升二级的钱为tower3_upgrade_coins[1]		伤害较低，但是群体伤害
